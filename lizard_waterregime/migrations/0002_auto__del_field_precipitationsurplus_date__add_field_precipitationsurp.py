...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PrecipitationSurplus.date'
        db.delete_column('lizard_waterregime_precipitationsurplus', 'date')

        # Adding field 'PrecipitationSurplus.date_modified'
        db.add_column('lizard_waterregime_precipitationsurplus', 'date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.date(2011, 4, 11), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PrecipitationSurplus.date'
        raise RuntimeError("Cannot reverse this migration. 'PrecipitationSurplus.date' and its values cannot be restored.")

        # Deleting field 'PrecipitationSurplus.date_modified'
        db.delete_column('lizard_waterregime_precipitationsurplus', 'date_modified')
